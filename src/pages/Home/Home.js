...
export default function Home() {
 ...
 <div className="Home">
      <div className="masthead">
        ...
        <main>
          <h1 id="headline">
            This is the great place, come on for vacation, business meeting ...
          </h1>
          <h2 id="about">
            Colchis is known in Greek mythology as the destination of the
            Argonauts, as well as the home to Medea and the Golden Fleece.[7] It
            was also described as a land rich with gold, iron, timber and honey
            that would export its resources mostly to ancient Hellenic
            city-states...
          </h2>
          <button class="purple-button">Click for more information</button>
        </main>
      </div>
    </div> 
    ...
    <section class="page-div-container">
		...
		<svg width="1420" height="1" viewBox="0 0 1420 1" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<div class="service-item">
			...
			<div class="icon-container">
				<svg width="34" height="60" viewBox="0 0 34 60" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path fill-rule="evenodd" clip-rule="evenodd" d="M29 2H5C3.34315 2 2 3.34315 2 5V55C2 56.6569 3.34315 58 5 58H29C30.6569 58 32 56.6569 32 55V5C32 3.34315 30.6569 2 29 2ZM5 0C2.23858 0 0 2.23858 0 5V55C0 57.7614 2.23858 60 5 60H29C31.7614 60 34 57.7614 34 55V5C34 2.23858 31.7614 0 29 0H5Z"
					 fill="#5528FF" />
			...
			<div class="media-container">
				<span class="service-item-title">Mobile Development</span>
				<div class="service-item-description">We develop mobile apps for all contemporary mobile platforms. Mamon team builds native and cross-platform solutions.</div>
			</div>
		...
		<div class="service-item">
			...
			<div class="icon-container">
				<svg width="70" height="61" viewBox="0 0 70 61" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path d="M33.1756 22.0587C34.321 21.4716 35.679 21.4716 36.8244 22.0587L65.8616 36.9403C68.7625 38.427 68.7625 42.573 65.8616 44.0597L36.8244 58.9413C35.679 59.5284 34.321 59.5284 33.1756 58.9413L4.13837 44.0597C1.23752 42.573 1.23752 38.427 4.13837 36.9403L33.1756 22.0587Z"
					 stroke="#5528FF" stroke-width="2" />
					<path d="M33.1756 12.0587C34.321 11.4716 35.679 11.4716 36.8244 12.0587L65.8616 26.9403C68.7625 28.427 68.7625 32.573 65.8616 34.0597L36.8244 48.9413C35.679 49.5284 34.321 49.5284 33.1756 48.9413L4.13837 34.0597C1.23752 32.573 1.23752 28.427 4.13837 26.9403L33.1756 12.0587Z"
					 fill="white" stroke="#5528FF" stroke-width="2" />
					<path d="M33.1756 2.05867C34.321 1.47164 35.679 1.47164 36.8244 2.05867L65.8616 16.9403C68.7625 18.427 68.7625 22.573 65.8616 24.0597L36.8244 38.9413C35.679 39.5284 34.321 39.5284 33.1756 38.9413L4.13837 24.0597C1.23752 22.573 1.23752 18.427 4.13837 16.9403L33.1756 2.05867Z"
					 fill="white" stroke="#5528FF" stroke-width="2" />
				</svg>
			</div>

			<div class="media-container">
				<span class="service-item-title">Product Design</span>
				<div class="service-item-description">We create design given the product audience, goal, business domain, technology and the platform for the solution.
				</div>
			</div>
